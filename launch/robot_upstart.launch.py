...
def generate_launch_description():
    ...
    diagnostics_enable = EnvironmentVariable(
        "TURTLEBOT4_DIAGNOSTICS", default_value="1"
    )
    ...
    pkg_turtlebot4_custom_upstart = get_package_share_directory(
    ...
    param_file_cmd = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [pkg_turtlebot4_custom_upstart, "config", "turtlebot4.yaml"]
        ),
